...
class GTL_DLLIMPEXP nxfDelegatingOutputStream : public nxfOutputStream {
    gnaPointer<nxfOutputStream> m_underlyingStream;

public:
    explicit nxfDelegatingOutputStream(gnaPointer<nxfOutputStream> underlyingStream)
