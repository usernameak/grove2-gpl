...
class grUiNativeDropSourcePlatformWin final : public IDropSource {
    ULONG m_refCount;
    gnaPointer<grUiObjectDragContext> m_ctx;

public:
    grUiNativeDropSourcePlatformWin();
    ~grUiNativeDropSourcePlatformWin();
    ...
    void set_dragContext(gnaPointer<grUiObjectDragContext> ctx);
};
